...
- (BOOL) matchPrimary
{
    ...
    if (![self matchSecondary]) goto L47;
    {}
    NSUInteger index50, yythunkpos51;
L52:
    index50=_index; yythunkpos51=yythunkpos;
    NSUInteger index54=_index, yythunkpos55=yythunkpos;
    if (![self matchADD]) goto L57;
    if (![self matchSecondary]) goto L57;
    [self yyDo:@selector(yy_1_Primary:) from:yybegin to:yyend];
    goto L56;
L57:
    _index=index54; yythunkpos=yythunkpos55;
    if (![self matchSUB]) goto L53;
    if (![self matchSecondary]) goto L53;
...
- (BOOL) matchSUB
{
    NSUInteger index62=_index, yythunkpos63=yythunkpos;
    yyprintf((stderr, "%s", "SUB"));
    if (![self _matchString:"-"]) goto L64;
    if (![self match_]) goto L64;
    yyprintf((stderr, "  ok   %s", "SUB"));
    return YES;
L64:
    _index=index62; yythunkpos=yythunkpos63;
    yyprintf((stderr, "  fail %s", "SUB"));
    return NO;
}
...
L74:
    ...
    [self yyDo:@selector(yy_1_Secondary:) from:yybegin to:yyend];
    goto L78;
L79:
    _index=index76; yythunkpos=yythunkpos77;
    if (![self matchDIV]) goto L75;
    if (![self matchTertiary]) goto L75;
    [self yyDo:@selector(yy_2_Secondary:) from:yybegin to:yyend];
    goto L78;
L78:
    goto L74;
L75:
...
L90:
    ...
    [self yyDo:@selector(yy_1_Terminal:) from:yybegin to:yyend];
    goto L89;
L89:
...
- (BOOL) matchTertiary
{
    NSUInteger index95=_index, yythunkpos96=yythunkpos;
    yyprintf((stderr, "%s", "Tertiary"));
    NSUInteger index98=_index, yythunkpos99=yythunkpos;
    if (![self matchTerminal]) goto L101;
    if (![self matchEXP]) goto L101;
    if (![self matchTertiary]) goto L101;
    [self yyDo:@selector(yy_1_Tertiary:) from:yybegin to:yyend];
    goto L100;
L101:
    _index=index98; yythunkpos=yythunkpos99;
    if (![self matchTerminal]) goto L97;
    goto L100;
L100:
...
- (BOOL) match_
{
    NSUInteger index104=_index, yythunkpos105=yythunkpos;
    yyprintf((stderr, "%s", "_"));
    {}
    NSUInteger index107, yythunkpos108;
L109:
    index107=_index; yythunkpos108=yythunkpos;
    if (![self _matchString:" "]) goto L110;
    goto L109;
L110:
    ...
    return YES;
L106:
    _index=index104; yythunkpos=yythunkpos105;
